...
class Users(AbstractUser):
    ...
    patronymic = models.CharField(max_length=30, blank=True, default="")
    passport = models.CharField(max_length=20, blank=True, default="")
    phone = models.CharField(max_length=20, blank=True, default="")
    email = models.EmailField(max_length=50, default="") #error_messages={
    # email = models.EmailField(max_length=50, unique=True, default="", error_messages={
